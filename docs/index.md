...
<div style={{textAlign: 'center'}}>
  ...
  <div style={{overflow: 'hidden', marginTop:'150px', marginLeft:'7%', marginRight:'7%'}}> 
    ...
    <p style={{textAlign: 'left', float: 'left', marginLeft:'20px', marginTop: '4%',  width:'78%', lineHeight: '2'}}> In 2021, I graduated from Beijing National Day School. It was the place where I began to learn computer science and programming. I took Mathematics, Physics, English, Chinese, Business, and Computer Science courses and completed the International Baccalaureate Diploma Programme (IBDP) here in three years. </p>
  </div>
